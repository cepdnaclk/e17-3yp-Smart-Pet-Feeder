      ...
      <div className="row">
        <div>
          <HeadingSection title="Hardware components" tagline="">
            ...
            As the other hardware components,It has included an 5MP Omnivision Camera Module, 0.91 Inch LCD Display, 
            L298N Dual Bridge DC Motor Controllers, 12v Stepper motor, Infrared IR Sensor and 5V Realy Module. 
           
            <h3>SENSORS</h3>
            The IR Sensor will be used to set the food container to its initial position and that Sensor shoul be given
             a input voltage between 3-5V.
            
            <h3>ACTUATORS</h3>
            When considering the actuators the 12v bipolar junction stepper motor has 200 step per revelution and 
            it is capable of giving a high-torque up to 40 N.cm. Then the raspberry pi camera mocdule will give a 
            Full HD video quality of 1080p with 30fps and if it reduced the quality to 720p the frame rate can be increased to 60fps.
            And the LCD display will be used for display the data such as signal strength, battery level and next feeding time.
            <p></p>
            Also a motor controller has used to control the speed, direction and rotating angle of the stepper motor. 
            A 5V relay module has used to supply the 5V input to the Raspberry PI from the 12V battery.
            <div className="pb-5">
              <img src={power} />
            </div>
