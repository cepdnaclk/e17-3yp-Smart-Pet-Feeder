        ...
        <div className="col-md-5 wrap-about py-md-5 ftco-animate fadeInUp ftco-animated">
          <HeadingSection title="Security Aspects" classAppend={"text-white"}>
            <div className="heading-section pr-md-5">
              ...
              phone. Another security mechanism is AWS Web application
              firewalls. The firewall helps to protect out API from common web
              attacks and bots. And also Json web token are used to communicate
              between API and the frontend. After user login to the system API
              will given a token to the frontend. So UI send request to the API
              along with the token. So the attackers cannot access our API
              without the token
            </div>
          </HeadingSection>
        </div>
